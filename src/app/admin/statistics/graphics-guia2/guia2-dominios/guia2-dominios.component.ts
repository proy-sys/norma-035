...
export class Guia2DominiosComponent {
  ...
  // ************************** 1 ***********************
  resultadoDominio1() {
    this.infoGuiasService.getResultadoDominio1(2).subscribe(
      data => {
  ...
  // ************************** 2 ***********************
  resultadoDominio2() {
    this.infoGuiasService.getResultadoDominio2(2).subscribe(
      data => {
  ...
  resultadoDominio3() {
    this.infoGuiasService.getResultadoDominio3(2).subscribe(
      data => {
  ...
  // ************************** 2 ***********************
  resultadoDominio4() {
    this.infoGuiasService.getResultadoDominio4(2).subscribe(
      data => {
  ...
  // ************************** 2 ***********************
  resultadoDominio5() {
    this.infoGuiasService.getResultadoDominio5(2).subscribe(
      data => {
  ...
  // ************************** 2 ***********************
  resultadoDominio6() {
    this.infoGuiasService.getResultadoDominio6(2).subscribe(
      data => {
  ...
  // ************************** 2 ***********************
  resultadoDominio7() {
    this.infoGuiasService.getResultadoDominio7(2).subscribe(
      data => {
  ...
  // ************************** 2 ***********************
  resultadoDominio8() {
    this.infoGuiasService.getResultadoDominio8(2).subscribe(
      data => {
